SELECT
    mname as revenue_munth,
    revenue_year,
    interest_payments as debt_payments,
    invoices-(purchase_orders+expenses+salaries) as net_income,
    invoices-(purchase_orders+expenses+salaries)-interest_payments as ending_cash_balance
FROM
    (SELECT 
        month_id,
            mname,
...
group by revenue_year, month_id